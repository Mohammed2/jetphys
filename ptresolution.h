...
const double vparul17b[_nres][3] =
...
const double vparul17c[_nres][3] =
...
const double vparul17d[_nres][3] =
...
const double vparul17e[_nres][3] =
...
const double vparul17f[_nres][3] =
...
double ptresponse(double pt, double eta) {
